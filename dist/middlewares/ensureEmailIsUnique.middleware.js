...
exports.ensureEmailIsUniqueMiddleware = void 0;
...
const ensureEmailIsUniqueMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const emailUser = yield userRepository.findOneBy({
        email: emailRequest,
    });
    if (emailUser) {
...
exports.ensureEmailIsUniqueMiddleware = ensureEmailIsUniqueMiddleware;
